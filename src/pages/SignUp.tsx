      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Join <span className="text-[#8EE0A1]">NightStay.ai</span>
          </h1>
          ...
          <CardHeader className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                size="sm"
                className={formData.userType === 'guest' ? 'bg-[#8EE0A1] hover:bg-[#7DD492] text-gray-900 flex-1' : 'flex-1'}
              ...
              <Button
                ...
                size="sm"
                className={formData.userType === 'owner' ? 'bg-[#8EE0A1] hover:bg-[#7DD492] text-gray-900 flex-1' : 'flex-1'}
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-600 leading-relaxed">
                    I agree to the{' '}
                    <Link to="/terms" className="text-[#22C55E] hover:text-[#16A34A] font-medium">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link to="/privacy" className="text-[#22C55E] hover:text-[#16A34A] font-medium">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <label htmlFor="marketing" className="text-sm text-gray-600 leading-relaxed">
                    I'd like to receive marketing emails about new features and special offers
                  </label>
                </div>
              </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/signin" className="font-medium text-[#22C55E] hover:text-[#16A34A]">
                  Sign in
                </Link>
              </p>
            </div>
